...
- **Library value** — an approximate USD total (standard store prices, discounts ignored) for whatever is on screen: your library, one family member's, or the whole family pool; member chips show each member's value on hover
